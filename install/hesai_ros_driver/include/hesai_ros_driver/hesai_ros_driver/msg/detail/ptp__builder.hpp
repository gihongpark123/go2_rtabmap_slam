...
class Init_Ptp_ptp_status_size
{
public:
  explicit Init_Ptp_ptp_status_size(::hesai_ros_driver::msg::Ptp & msg)
  : msg_(msg)
  {}
  Init_Ptp_ptp_status ptp_status_size(::hesai_ros_driver::msg::Ptp::_ptp_status_size_type arg)
  {
    msg_.ptp_status_size = std::move(arg);
...
public:
  ...
  {}
  Init_Ptp_ptp_status_size ptp_lock_offset(::hesai_ros_driver::msg::Ptp::_ptp_lock_offset_type arg)
  {
    msg_.ptp_lock_offset = std::move(arg);
    return Init_Ptp_ptp_status_size(msg_);
  }
