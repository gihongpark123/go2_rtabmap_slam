...
bool hesai_ros_driver__msg__Ptp__rosidl_typesupport_introspection_c__resize_function__Ptp__ptp_status(
...
static rosidl_typesupport_introspection_c__MessageMember hesai_ros_driver__msg__Ptp__rosidl_typesupport_introspection_c__Ptp_message_member_array[3] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hesai_ros_driver__msg__Ptp, ptp_status_size),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    hesai_ros_driver__msg__Ptp__rosidl_typesupport_introspection_c__resize_function__Ptp__ptp_status  // resize(index) function pointer
  }
};
