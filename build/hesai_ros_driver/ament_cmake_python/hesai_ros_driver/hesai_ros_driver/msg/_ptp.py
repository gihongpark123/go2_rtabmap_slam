...
class Ptp(metaclass=Metaclass_Ptp):
    ...
    _fields_and_field_types = {
        ...
        'ptp_status_size': 'uint32',
        'ptp_status': 'sequence<uint8>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.ptp_status_size = kwargs.get('ptp_status_size', int())
        self.ptp_status = array.array('B', kwargs.get('ptp_status', []))
    ...
    def __eq__(self, other):
        ...
        if self.ptp_lock_offset != other.ptp_lock_offset:
            return False
        if self.ptp_status_size != other.ptp_status_size:
            return False
    ...
    @builtins.property
    def ptp_status_size(self):
        """Message field 'ptp_status_size'."""
        return self._ptp_status_size

    @ptp_status_size.setter
    def ptp_status_size(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ptp_status_size' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'ptp_status_size' field must be an unsigned integer in [0, 4294967295]"
        self._ptp_status_size = value
    ...
    def ptp_status(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'ptp_status' array.array() must have the type code of 'B'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'ptp_status' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._ptp_status = array.array('B', value)
