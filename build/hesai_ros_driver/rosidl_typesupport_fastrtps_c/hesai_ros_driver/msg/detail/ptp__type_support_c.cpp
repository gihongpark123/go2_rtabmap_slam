...
#include "rosidl_runtime_c/primitives_sequence.h"  // ptp_status
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // ptp_status
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ptp_status_size
  {
    cdr << ros_message->ptp_status_size;
  }

  // Field name: ptp_status
  {
    size_t size = ros_message->ptp_status.size;
    auto array_ptr = ros_message->ptp_status.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ptp_status
  {
    ...
    if (ros_message->ptp_status.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->ptp_status);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->ptp_status, size)) {
      fprintf(stderr, "failed to create array for field 'ptp_status'");
      return false;
    }
    auto array_ptr = ros_message->ptp_status.data;
  ...
  size_t current_alignment)
{
  ...
  // field.name ptp_status_size
  {
    size_t item_size = sizeof(ros_message->ptp_status_size);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name ptp_status
  {
    size_t array_size = ros_message->ptp_status.size;
    auto array_ptr = ros_message->ptp_status.data;
