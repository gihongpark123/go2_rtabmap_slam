...
hesai_ros_driver__msg__Ptp__init(hesai_ros_driver__msg__Ptp * msg)
{
  ...
  // ptp_status_size
  // ptp_status
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->ptp_status, 0)) {
...
hesai_ros_driver__msg__Ptp__fini(hesai_ros_driver__msg__Ptp * msg)
{
  ...
  // ptp_status_size
  // ptp_status
  rosidl_runtime_c__uint8__Sequence__fini(&msg->ptp_status);
}
...
hesai_ros_driver__msg__Ptp__are_equal(const hesai_ros_driver__msg__Ptp * lhs, const hesai_ros_driver__msg__Ptp * rhs)
{
  ...
  // ptp_status_size
  if (lhs->ptp_status_size != rhs->ptp_status_size) {
    return false;
  }
  // ptp_status
  ...
  hesai_ros_driver__msg__Ptp * output)
{
  ...
  // ptp_status_size
  output->ptp_status_size = input->ptp_status_size;
  // ptp_status
